...
const Card = () => {
  return (
    <div class="flex flex-col items-center justify-center bg-blue-600 p-4 shadow rounded-lg">
      ...
      <h2 class="mt-4 font-bold text-xl text-white">Sebastian Bennett</h2>
      <h6 class="mt-2 text-sm font-medium text-white">Founder</h6>

      <p class="text-xs text-white text-center mt-3">
